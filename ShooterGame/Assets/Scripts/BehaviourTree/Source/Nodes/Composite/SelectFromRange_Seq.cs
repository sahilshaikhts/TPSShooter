...
namespace Behaviourtree
{
    ...
    /// Return value similar to Sequence.
    /// </summary>
    public class SelectFromRange_Seq : Node
    {
        Vector2[] m_range;
        string key_value;
        ...
        public SelectFromRange_Seq(BehaviourTree aTree, Vector2[] aRange, string aKeyValueToCheck) : base(aTree)
        {
